...
//                                     <div class="col-sm-10">
//                           <h5 class="card-title"><b>Все магазины отмодерированы!</h5>
//                            <p class="card-text" id="cardText"><b>Больше магазиноов нет, но есть замечательный кот!<br>
//
//                             </p>
//
//                         </div>
//                         <img class="col-sm-10 text-right" src="https://w-dog.ru/wallpapers/5/19/361416555427750/kot-kotenok-seryj-pushistyj-lapy-kogotki.jpg" alt="https://iproger.ru/content/news/46014.jpg"/>
//                     </div>
//                 </div>
//                 </div>
//                 </div>
